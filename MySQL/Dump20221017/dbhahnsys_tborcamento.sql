...
CREATE TABLE `tborcamento` (
  `idorc` int NOT NULL AUTO_INCREMENT,
  `nomecli` varchar(50) NOT NULL,
  `endereco` varchar(100) DEFAULT NULL,
  `totvalor` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`idorc`)
...
LOCK TABLES `tborcamento` WRITE;
/*!40000 ALTER TABLE `tborcamento` DISABLE KEYS */;
/*!40000 ALTER TABLE `tborcamento` ENABLE KEYS */;
UNLOCK TABLES;
